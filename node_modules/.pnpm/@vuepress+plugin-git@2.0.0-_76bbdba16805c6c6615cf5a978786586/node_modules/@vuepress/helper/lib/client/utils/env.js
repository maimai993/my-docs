 ...
 */
export const isiPhone = () => /\b(iPhone|iPod)\b/i.test(navigator.userAgent);
const hasMacUA = () => /macintosh|mac os x/i.test(navigator.userAgent);
/**
 ...
 */
export const isMacOS = () => hasMacUA() && !isIOS();
/**
 ...
 */
export const isMobile = () => /\b(Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini|Mobile|mobile|CriOS|FxiOS)\b/i.test(navigator.userAgent);
/**
 ...
 */
export const isChromeWebView = () => /(?!Chrom.*OPR)wv\).*?Chrome\//i.test(navigator.userAgent);
/**
 ...
 */
export const isSafariMobile = () => isSafari() && isMobile();
